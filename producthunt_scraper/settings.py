...
# Root directory for producthunt_scraper project
BASE_DIR = Path(__file__).resolve().parent.parent

# Root data directory for producthunt_scraper project
...
USER_AGENT = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36"  # noqa
